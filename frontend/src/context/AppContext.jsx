...
const AppContextProvider = ({ children }) => {
  ...
  const [admin, setAdmin] = useState(false); // default false
    ...
    setCartItems((prev) => {
      ...
      if (existing) {
        return prev.map((item) =>
          item._id === menu._id ? { ...item, quantity: item.quantity + qty } : item
        );
      }
  ...
  // ✅ Check authentication and set user/admin correctly
